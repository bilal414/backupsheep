...
from apps.api.v1.backup.aws.filters import CoreAWSBackupFilter
from apps.api.v1.backup.mixins import VisibleNodeBackupMixin
from apps.api.v1.backup.aws.permissions import (
    CoreAWSBackupViewPermissions,
)
from apps.api.v1.backup.aws.serializers import CoreAWSBackupSerializer
...
class CoreAWSBackupView(VisibleNodeBackupMixin, viewsets.ModelViewSet):
    permission_classes = (IsAuthenticated, CoreAWSBackupViewPermissions)
    serializer_class = CoreAWSBackupSerializer
    backup_model = CoreAWSBackup
    backup_node_relation = "aws"
