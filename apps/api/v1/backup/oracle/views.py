...
from apps.api.v1.backup.oracle.filters import CoreOracleBackupFilter
from apps.api.v1.backup.mixins import VisibleNodeBackupMixin
from apps.api.v1.backup.oracle.permissions import (
    CoreOracleBackupViewPermissions,
)
from apps.api.v1.backup.oracle.serializers import CoreOracleBackupSerializer
...
class CoreOracleBackupView(VisibleNodeBackupMixin, viewsets.ModelViewSet):
    permission_classes = (IsAuthenticated, CoreOracleBackupViewPermissions)
    serializer_class = CoreOracleBackupSerializer
    backup_model = CoreOracleBackup
    backup_node_relation = "oracle"
