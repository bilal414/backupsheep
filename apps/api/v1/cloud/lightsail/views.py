...
from apps.console.api.v1.cloud.lightsail.filters import CoreCloudLightsailFilter
from apps.console.api.v1.cloud.lightsail.permissions import CoreCloudLightsailViewPermissions
from apps.console.api.v1.cloud.lightsail.serializers import CoreCloudLightsailReadSerializer, CoreCloudLightsailWriteSerializer
...
class CoreCloudLightsailView(ReadWriteSerializerMixin, viewsets.ModelViewSet):
    permission_classes = (IsAuthenticated, CoreCloudLightsailViewPermissions,)
    read_serializer_class = CoreCloudLightsailReadSerializer
    write_serializer_class = CoreCloudLightsailWriteSerializer
    ...
    filterset_class = CoreCloudLightsailFilter
