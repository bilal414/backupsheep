...
from apps.api.v1.cloud.ovh_us.filters import CoreCloudOVHUSFilter
from apps.api.v1.cloud.ovh_us.permissions import CoreCloudOVHUSViewPermissions
from apps.api.v1.cloud.ovh_us.serializers import CoreCloudOVHUSReadSerializer, CoreCloudOVHUSWriteSerializer
...
class CoreCloudOVHUSView(ReadWriteSerializerMixin, viewsets.ModelViewSet):
    ...
    def totals(self, request):
        ...
        all_totals = {
            ...
            "storage": 0,
            "in_progress": CoreOVHUSBackup.objects.filter(
                ovh_us__in=nodes, status__in=UtilBackup.ACTIVE_STATUSES
            ).count(),
        }
