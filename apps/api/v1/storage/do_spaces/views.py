...
from .filters import CoreStorageDoSpacesFilter
from .permissions import CoreStorageDoSpacesPermissions
from .serializers import CoreStorageReadSerializer, CoreStorageWriteSerializer
from apps._tasks.exceptions import IntegrationValidationFailed, StorageValidationFailed
from ...utils.api_filters import DateRangeFilter
from ...utils.api_helpers import get_start_end_of_previous_day
from ...utils.api_serializers import ReadWriteSerializerMixin


class CoreStorageDoSpacesView(ReadWriteSerializerMixin, viewsets.ModelViewSet):
    permission_classes = (IsAuthenticated, CoreStorageDoSpacesPermissions,)
    ...
    filterset_class = CoreStorageDoSpacesFilter
    ...
    def get_queryset(self):
        ...
        query = Q(account=member.get_current_account(), type__code="do_spaces")
    ...
    def validate(self, request, pk=None):
        try:
            storage = self.get_object()
            validation = storage.storage_do_spaces.validate()
            if validation:
                return Response(
    ...
    def highcharts(self, request):
        ...
        graph["series"].append(
            {
                "name": "DigitalOcean Spaces Storage",
                "data": temp_data,
                "visible": True,
            }
        )
