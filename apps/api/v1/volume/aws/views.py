...
from apps.console.api.v1.volume.aws.filters import CoreVolumeAWSFilter
from apps.console.api.v1.volume.aws.permissions import CoreVolumeAWSViewPermissions
from apps.console.api.v1.volume.aws.serializers import CoreVolumeAWSReadSerializer, CoreVolumeAWSWriteSerializer
...
class CoreVolumeAWSView(ReadWriteSerializerMixin, viewsets.ModelViewSet):
    permission_classes = (IsAuthenticated, CoreVolumeAWSViewPermissions,)
    read_serializer_class = CoreVolumeAWSReadSerializer
    write_serializer_class = CoreVolumeAWSWriteSerializer
    ...
    filterset_class = CoreVolumeAWSFilter
