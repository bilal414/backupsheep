...
class CoreVolumeLinodeView(ReadWriteSerializerMixin, viewsets.ModelViewSet):
    permission_classes = (IsAuthenticated, CoreVolumeLinodeViewPermissions,)
    read_serializer_class = CoreVolumeLinodeReadSerializer
    write_serializer_class = CoreVolumeLinodeWriteSerializer
    ...
    filterset_class = CoreVolumeLinodeFilter
