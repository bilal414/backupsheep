...
class CoreVolumeOracleReadSerializer(serializers.ModelSerializer):
...
class CoreVolumeOracleWriteSerializer(serializers.ModelSerializer):
    ...
    def validate(self, data):
        ...
        if connection is None or integration_code != "oracle":
            raise serializers.ValidationError(
                "Select an Oracle Cloud connection for this volume."
            )
    ...
    def create(self, validated_data):
        ...
        instance = CoreOracle.objects.create(**validated_data)
        return instance
