...
urlpatterns += [
    path(
        ...
        include(
            [
                path("", include("apps.api.v1.volume.digitalocean.urls")),
                path("", include("apps.api.v1.volume.aws.urls")),
                path("", include("apps.api.v1.volume.vultr.urls")),
                ...
                path("", include("apps.api.v1.volume.google_cloud.urls")),
            ]
        ),
    ),
]
